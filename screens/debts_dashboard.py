...
from screens.debts_form import DebtsForm

class DebtsDashboardFrame(BaseView):
    def __init__(self, master):
        super().__init__(master, "Debts", add_button_command=self.goto_add)
    ...
    def refresh(self):
        ...
        cursor = conn.cursor()
        cursor.execute("SELECT id, name, amount, date, user FROM debts")
    ...
    def goto_add(self):
        ...
        form = DebtsForm(window, self.master, self)
