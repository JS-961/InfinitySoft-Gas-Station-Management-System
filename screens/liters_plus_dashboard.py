...
from screens.liters_plus_form import LitersPlusForm

class LitersPlusDashboardFrame(BaseView):
    def __init__(self, master):
        super().__init__(master, "Liters Plus", add_button_command=self.goto_add)
    ...
    def refresh(self):
        ...
        cursor = conn.cursor()
        cursor.execute("SELECT id, type, quantity, price, date, user FROM liters_plus")
    ...
    def goto_add(self):
        ...
        window.title("Add Liters Plus Entry")
        ...
        form = LitersPlusForm(window, self.master, self)
